...
public class MyStatusViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyStatusViewHolder(View itemView, CareListCallback careListCallback) {
        super(itemView);
    ...
    public void renderData(FirebaseStatusData firebaseStatusData) {

        UserDataVO userDataVO = FUserManager.getInstance(itemView.getContext()).getUserDataVO();
    ...
    private void renderLocality(FirebaseLocationStatus firebaseLocationStatus) {
        if(firebaseLocationStatus != null && firebaseLocationStatus.getLocality() != null) {
    ...
    private void renderWeatherStatus(FirebaseWeatherData firebaseWeatherData) {
        if(firebaseWeatherData != null && firebaseWeatherData.getWeatherEnum() != null) {
            ...
            if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.CLEAR_DAY.getName())) {
                weatherIcon.setBackground(ActivityCompat.getDrawable(weatherIcon.getContext(), R.drawable.ic_sun));
                climateText.setText("SUNNY");
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.cLEAR_NIGHT.getName())) {
            ...
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.PARTLY_CLOUDY_DAY.getName())) {
            ...
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.PARTLY_CLOUDY_NIGHT.getName())) {
                weatherIcon.setBackground(ActivityCompat.getDrawable(weatherIcon.getContext(), R.drawable.ic_weather_partlycloudy));
                climateText.setText("PARTLY CLOUDY");
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.CLOUDY.getName())) {
            ...
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.RAINY.getName())) {
                weatherIcon.setBackground(ActivityCompat.getDrawable(weatherIcon.getContext(), R.drawable.ic_rain));
                climateText.setText("RAINY");
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.SNOW.getName())) {
                weatherIcon.setBackground(ActivityCompat.getDrawable(weatherIcon.getContext(), R.drawable.ic_snow));
                climateText.setText("SNOW");
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.SLEET.getName())) {
                weatherIcon.setBackground(ActivityCompat.getDrawable(weatherIcon.getContext(), R.drawable.ic_snow));
                climateText.setText("SLEETY");
            } else if(firebaseWeatherData.getWeatherEnum().equalsIgnoreCase(WeatherEnum.WIND.getName())) {
                weatherIcon.setBackground(ActivityCompat.getDrawable(weatherIcon.getContext(), R.drawable.ic_snow));
